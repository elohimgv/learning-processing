class RenderToki {
  ...
  // Construct method
  RenderToki(boolean T, float percentage) {
    if (T) {
      xspeed = 3;
      yspeed = 3;
      
      x_head = (250 * percentage) / 100;
      y_head = (130 * percentage) / 100;
      sizeHead = (70 * percentage) / 100;
      
      x1_reyebrow = (220 * percentage) / 100;
      y1_reyebrow = (130 * percentage) / 100;
      x2_reyebrow = (230 * percentage) / 100;
      y2_reyebrow = (120 * percentage) / 100;
      
      x_reye = (230 * percentage) / 100;
      y_reye = (130 * percentage) / 100;
      
      x1_leyebrow = (240 * percentage) / 100;
      y1_leyebrow = (113 * percentage) / 100;
      x2_leyebrow = (260 * percentage) / 100;
      y2_leyebrow = (113 * percentage) / 100;
      
      x_leye = (250 * percentage) / 100;
      y_leye = (120 * percentage) / 100;
      
      x1_nose = (240 * percentage) / 100;
      y1_nose = (130 * percentage) / 100;
      x2_nose = (240 * percentage) / 100;
      y2_nose = (140 * percentage) / 100;
      x3_nose = (240 * percentage) / 100;
      y3_nose = (140 * percentage) / 100;
      x4_nose = (250 * percentage) / 100;
      y4_nose = (135 * percentage) / 100;
      
      x1_mouth = (240 * percentage) / 100;
      y1_mouth = (155 * percentage) / 100;
      x2_mouth = (245 * percentage) / 100;
      y2_mouth = (148 * percentage) / 100;
      x3_mouth = (245 * percentage) / 100;
      y3_mouth = (148 * percentage) / 100;
      x4_mouth = (255 * percentage) / 100;
      y4_mouth = (148 * percentage) / 100;
      
      x1_col = (250 * percentage) / 100;
      y1_col = (165 * percentage) / 100;
      x2_col = (250 * percentage) / 100;
      y2_col = (280 * percentage) / 100;
      
      x1_rarm = (250 * percentage) / 100;
      y1_rarm = (200 * percentage) / 100;
      x2_rarm = (220 * percentage) / 100;
      y2_rarm = (280 * percentage) / 100;
      
      x1_rhand = (205 * percentage) / 100;
      y1_rhand = (280 * percentage) / 100;
      x2_rhand = (220 * percentage) / 100;
      y2_rhand = (280 * percentage) / 100;
      
      x1_larm = (250 * percentage) / 100;
      y1_larm = (200 * percentage) / 100;
      x2_larm = (235 * percentage) / 100;
      y2_larm = (270 * percentage) / 100;
      
      x1_lhand = (220 * percentage) / 100;
      y1_lhand = (270 * percentage) / 100;
      x2_lhand = (235 * percentage) / 100;
      y2_lhand = (270 * percentage) / 100;
      
      x1_lleg = (250 * percentage) / 100;
      y1_lleg = (280 * percentage) / 100;
      x2_lleg = (315 * percentage) / 100;
      y2_lleg = (265 * percentage) / 100;
      x3_lleg = (315 * percentage) / 100;
      y3_lleg = (265 * percentage) / 100;
      x4_lleg = (330 * percentage) / 100;
      y4_lleg = (330 * percentage) / 100;
      
      x1_lfoot = (330 * percentage) / 100;
      y1_lfoot = (330 * percentage) / 100;
      x2_lfoot = (345 * percentage) / 100;
      y2_lfoot = (330 * percentage) / 100;
      
      x1_rleg = (250 * percentage) / 100;
      y1_rleg = (280 * percentage) / 100;
      x2_rleg = (310 * percentage) / 100;
      y2_rleg = (300 * percentage) / 100;
      x3_rleg = (310 * percentage) / 100;
      y3_rleg = (300 * percentage) / 100;
      x4_rleg = (305 * percentage) / 100;
      y4_rleg = (365 * percentage) / 100;
      
      x1_rfoot = (305 * percentage) / 100;
      y1_rfoot = (365 * percentage) / 100;
      x2_rfoot = (320 * percentage) / 100;
      y2_rfoot = (365 * percentage) / 100;
    } else {
      xspeed = 3;
      yspeed = 3;
